...
if __name__ == '__main__':
    ...
    # momentum 动量法
    # 3. 定义优化器
    x_momentum = x.clone().detach().requires_grad_(True)
    optimizer = optim.SGD([x_momentum], lr=lr, momentum=0.9) # momentum 历史梯度权重参数

    # 4. 梯度下降法寻找最小值
    x0_list, x1_list = gradient_descent(x_momentum, optimizer, num_iters)
